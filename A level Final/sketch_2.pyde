...
p1 = polygon_4("test_rgb_3")
p2 = polygon_4("test_rgb_2")

p1.rotation_matrix.add(0.25,0,0.1)
p1.scale_matrix = vector_3d(10,10,10)
p1.move_matrix = vector_3d(20,20)

p2.rotation_matrix.add(0.1,0,0)
p2.scale_matrix = vector_3d(10,10,10)
p2.move_matrix = vector_3d(20,20)

polygons = [p1,p2]
        
def draw():
    p1.rotation_matrix.add(0.01,0,0)
    p2.rotation_matrix.add(0,0.01,0)
